...
extern void findFItemset(FILE *file, ItemLink *trans, NodeLink *np, int support,
		int transNum, int itemsNum);
extern int hash(char *buf, int tableSize);
extern void createFItemset(ItemLink *tracts, int idx, NodeLink *np, int support,
		char *trans, int itemsNum);
extern void createTract(ItemLink *tracts, int idx, char *field);
extern void deleteUnsupport(ItemLink *tracts, int length, int support,
		NodeLink *hashTable, int size);
extern void sortEveryTract(ItemLink *tracts, int length, NodeLink *ht, int size,
		int support);
extern void selectSort(ItemLink *head, NodeLink *ht, int size, int support);
extern void createHashTable(NodeLink *np, char *field, int support,
		int hashSize);
